...
[^1]: tvOS and watchOS do not have [Core MIDI I/O support](https://github.com/orchetect/swift-midi-io), but this package will compile and is otherwise usable.
...
See the [online documentation](https://swiftpackageindex.com/orchetect/swift-midi-sync/main/documentation) for this repository and its [Examples](Examples) folder.
