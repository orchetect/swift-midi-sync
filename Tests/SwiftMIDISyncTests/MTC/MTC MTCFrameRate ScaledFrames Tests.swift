...
@Suite
struct MTC_MTCFrameRate_ScaledFrames_Tests {
    // Local Constants

    private var mtc24: MTCFrameRate {
        .mtc24
    }

    private var mtc25: MTCFrameRate {
        .mtc25
    }

    private var mtcDF: MTCFrameRate {
        .mtc2997d
    }

    private var mtc30: MTCFrameRate {
        .mtc30
    }
    ...
    @Test
    func mtcRoundTrip_ScaledFrames() throws {
        for realRate in TimecodeFrameRate.allCases {
            // zero
            do {
            ...
            do {
                for frame in 0 ... realRate.maxFrameNumberDisplayable {
                    ...
                    let scaledToTimecode = try #require(realRate.mtcFrameRate
                        .scaledFrames(
                            fromRawMTCFrames: scaledToMTC.rawMTCFrames,
                            quarterFrames: scaledToMTC.rawMTCQuarterFrames,
                            to: realRate
